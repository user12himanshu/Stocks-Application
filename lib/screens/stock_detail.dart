...
import 'package:stocks_application/screens/utils.dart';
...
class _StockDetailState extends State<StockDetail> {
  ...
  @override
  void initState() {
    apiServiceAdvantage.getDailyData(widget.stockSymbol);
      ...
      body: Container(
        ...
        child: FutureBuilder<StockQuoteAdvantange?>(
          future: asyncMemoizer.runOnce(
              () => apiServiceAdvantage.getStockQuote(widget.stockSymbol)),
                                                      ...
                                                      Container(
                                                        ...
                                                        margin:
                                                            EdgeInsets.fromLTRB(
                                                                ...
                                                                2 * fem),
                                                        child: Text(
                                                          widget.stockInfo.the2Name!,       style: SafeGoogleFont(
                                                            'Roboto',
                                                            fontSize: 16 * ffem,
                                                            fontWeight:
                                                                FontWeight.w700,
